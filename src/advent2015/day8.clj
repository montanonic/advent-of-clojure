;; Credit to Derek Slager https://github.com/derekslager/advent-of-code-2015/blob/master/src/advent_of_code_2015/day8.clj
(ns advent2015.day8
...
(defn run []
  (let [resource (slurp (io/resource "../src/advent2015/day8.txt"))
